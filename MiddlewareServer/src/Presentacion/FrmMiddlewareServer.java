 ...
 * @author Equipo 5
 */
public class FrmMiddlewareServer extends javax.swing.JFrame {

    private final static int UI_THEME = 1;
    private final static String VERSION = "0.0.1";

    private static FrmMiddlewareServer instance;
    ...
    public static void main(String args[]) {
        ...
        SwingUtilities.invokeLater(() -> {
            FrmMiddlewareServer.getInstance().setVisible(true);
        });
    }
     ...
     */
    public static FrmMiddlewareServer getInstance() {
        if (instance == null) {
            instance = new FrmMiddlewareServer();
        }
        return instance;
    }

    /**
     * Creates new form FrmMiddlewareServer
     */
    private FrmMiddlewareServer() {
        initComponents();
    }
